...
> 실습 준비: [이 절의 노트북 보기](../notebooks/06-8-echo-project.ipynb) · [06장 교육자료 ZIP 받기](https://github.com/zxz3650/Python/raw/refs/heads/master/downloads/chapter-06.zip) · [자료 준비·실행 안내](../PRACTICE.md#download)
>
...
4. 07장에서 같은 TCP 위의 HTTP 요청·응답 구조와 비교합니다.
5. 07장의 로컬 보안 점검 프로젝트에서 TCP 연결 확인을 재사용합니다.
